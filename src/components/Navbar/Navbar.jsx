        ...
        <div className="bg-primary/40 py-2">
            <div className="container flex justify-between items-center">
                ...
                <div className="flex justify-between items-center gap-4">
                    ...
                    {/* Order Button */}
                    <button onClick={() => alert("Ordering not available yet")} className="bg-gradient-to-r from-primary to-secondary transition-all duration-200
        ...
        <div className="flex justify-center">
            <ul className="sm:flex hidden items-center gap-4">
                ...
                <li className="group relative cursor-pointer">
                    ...
                    <div className="absolute z-[9999] hidden group-hover:block w-[150w] rounded-md bg-white p-2 text-black shadow-md">
                        <ul>
